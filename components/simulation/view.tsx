...
const ResultSimulation = (announcementContent: Params) => {
    ...
    return (
        <div className="flex flex-col sm:flex-row gap-7 max-w-screen-lg max-h-[400px] my-6 sm:my-[84px] sm:mx-auto  mx-2.5">
            <CardCar
            ...
            <div className="mx-auto px-4 flex flex-col bg-[#FAFAFA] w-full max-w-screen-lg">
                <div className="py-6 flex flex-col gap-2">
                    <div className="flex flex-col pb-2 hidden sm:block">
